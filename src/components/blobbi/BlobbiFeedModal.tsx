...
export function BlobbiFeedModal({ isOpen, onClose, onOpenShop, onFoodSelected }: BlobbiFeedModalProps) {
        ...
        {isProfileLoading ? (
          ...
          <div className="text-center py-16 space-y-8">
            <div className="relative">
              <div className="w-20 h-20 mx-auto rounded-3xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center shadow-xl">
                      ...
                      <div className="relative p-4 pb-3">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex items-center gap-1.5 px-2.5 py-1 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/40 dark:to-pink-900/40 rounded-full border border-purple-200/50 dark:border-purple-600/50">
                            ...
                            <span className="text-xs font-semibold text-purple-700 dark:text-purple-300">×{food.quantity}</span>
                          </div>
                        </div>
                      </div>
